...
################################################################
# This is a generated script based on design: Pong
#
...
# source Pong_script.tcl


# The design that will be created by this Tcl script contains the following 
# module references:
# rgb2tmds, timing_generator
...
if { $bCheckIPs == 1 } {
   set list_check_ips "\ 
askaradogan.github.io:user:Pong:1.0\
...
proc create_root_design { parentCell } {
  ...
  set btn_4bits [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 btn_4bits ]
  ...
  set data_n_0 [ create_bd_port -dir O -from 2 -to 0 data_n_0 ]
  set data_p_0 [ create_bd_port -dir O -from 2 -to 0 data_p_0 ]

  # Create instance: Pong_1, and set properties
  set Pong_1 [ create_bd_cell -type ip -vlnv askaradogan.github.io:user:Pong:1.0 Pong_1 ]
  ...
  set block_name rgb2tmds
  set block_cell_name rgb2tmds_0
  if { [catch {set rgb2tmds_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $rgb2tmds_0 eq "" } {
  ...
  # Create instance: timing_generator_0, and set properties
  set block_name timing_generator
  set block_cell_name timing_generator_0
  if { [catch {set timing_generator_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $timing_generator_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create interface connections
  connect_bd_intf_net -intf_net axi_gpio_0_GPIO [get_bd_intf_ports btn_4bits] [get_bd_intf_pins axi_gpio_0/GPIO]
  ...
  connect_bd_intf_net -intf_net smartconnect_0_M00_AXI [get_bd_intf_pins Pong_1/S_AXI] [get_bd_intf_pins smartconnect_0/M00_AXI]
  ...
  connect_bd_net -net Pong_1_o_hsync [get_bd_pins Pong_1/o_hsync] [get_bd_pins rgb2tmds_0/hsync]
  connect_bd_net -net Pong_1_o_vsync [get_bd_pins Pong_1/o_vsync] [get_bd_pins rgb2tmds_0/vsync]
  connect_bd_net -net Pong_1_video_data [get_bd_pins Pong_1/video_data] [get_bd_pins rgb2tmds_0/video_data]
  connect_bd_net -net clk_wiz_0_pclk [get_bd_pins Pong_1/pclk] [get_bd_pins clk_wiz_0/pclk] [get_bd_pins proc_sys_reset_1/slowest_sync_clk] [get_bd_pins rgb2tmds_0/pixelclock] [get_bd_pins timing_generator_0/clk]
  connect_bd_net -net clk_wiz_0_sclk [get_bd_pins clk_wiz_0/sclk] [get_bd_pins rgb2tmds_0/serialclock]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins Pong_1/s_axi_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins smartconnect_0/aresetn]
  connect_bd_net -net proc_sys_reset_1_peripheral_reset [get_bd_pins proc_sys_reset_1/peripheral_reset] [get_bd_pins rgb2tmds_0/rst]
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_pins Pong_1/s_axi_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins smartconnect_0/aclk]
  ...
  connect_bd_net -net rgb2tmds_0_clk_n [get_bd_ports clk_n_0] [get_bd_pins rgb2tmds_0/clk_n]
  connect_bd_net -net rgb2tmds_0_clk_p [get_bd_ports clk_p_0] [get_bd_pins rgb2tmds_0/clk_p]
  connect_bd_net -net rgb2tmds_0_data_n [get_bd_ports data_n_0] [get_bd_pins rgb2tmds_0/data_n]
  connect_bd_net -net rgb2tmds_0_data_p [get_bd_ports data_p_0] [get_bd_pins rgb2tmds_0/data_p]
  connect_bd_net -net timing_generator_0_hsync [get_bd_pins Pong_1/i_hsync] [get_bd_pins timing_generator_0/hsync]
  connect_bd_net -net timing_generator_0_pixel_x [get_bd_pins Pong_1/pixel_x] [get_bd_pins timing_generator_0/pixel_x]
  connect_bd_net -net timing_generator_0_pixel_y [get_bd_pins Pong_1/pixel_y] [get_bd_pins timing_generator_0/pixel_y]
  connect_bd_net -net timing_generator_0_video_active [get_bd_pins Pong_1/video_active] [get_bd_pins rgb2tmds_0/video_active] [get_bd_pins timing_generator_0/video_active]
  connect_bd_net -net timing_generator_0_vsync [get_bd_pins Pong_1/i_vsync] [get_bd_pins timing_generator_0/vsync]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs Pong_1/S_AXI/S_AXI_reg] SEG_Pong_1_S_AXI_reg
